/******/ (() => {
          ...
          var e,
            ...
            F = function (a, n, o, r) {
              ...
              (g.id = e.ID + "-" + T),
                ...
                e.rtl &&
                  (g.setAttribute("dir", "rtl"), g.classList.add("nx-rtl-on")),
            ...
            j = function (e, a, n, o, r, l) {
              ...
              (x.id = p.ID),
                ...
                i.rtl &&
                  (x.setAttribute("dir", "rtl"), x.classList.add("nx-rtl-on")),
  ...
  (() => {
    "use strict"; // CONCATENATED MODULE: ./node_modules/@lit/reactive-element/css-tag.js
     ...
     */
    const css_tag_t = window,
      e =
        css_tag_t.ShadowRoot &&
        (void 0 === css_tag_t.ShadyCSS || css_tag_t.ShadyCSS.nativeShadow) &&
      ...
      c = e
        ...
        : (t) =>
            t instanceof CSSStyleSheet
              ...
              : t; // CONCATENATED MODULE: ./node_modules/@lit/reactive-element/reactive-element.js
    ...
    const reactive_element_e = window,
      reactive_element_r = reactive_element_e.trustedTypes,
      h = reactive_element_r ? reactive_element_r.emptyScript : "",
      reactive_element_o = reactive_element_e.reactiveElementPolyfillSupport,
      reactive_element_n = {
        toAttribute(t, i) {
          switch (i) {
            case Boolean:
    ...
    (d.finalized = !0),
      ...
      null == reactive_element_o || reactive_element_o({ ReactiveElement: d }),
      (null !==
        (reactive_element_s = reactive_element_e.reactiveElementVersions) &&
      void 0 !== reactive_element_s
        ? reactive_element_s
        : (reactive_element_e.reactiveElementVersions = [])
      ).push("1.6.1"); // CONCATENATED MODULE: ./node_modules/lit-html/lit-html.js
    ...
    const lit_html_i = window,
      ...
      lit_html_e = lit_html_s
        ? lit_html_s.createPolicy("lit-html", { createHTML: (t) => t })
        : void 0,
      lit_html_o = `lit$${(Math.random() + "").slice(9)}$`,
      lit_html_n = "?" + lit_html_o,
      lit_html_l = `<${lit_html_n}>`,
      lit_html_h = document,
      lit_html_r = (t = "") => lit_html_h.createComment(t),
      lit_html_d = (t) =>
      ...
      T = new WeakMap(),
      A = lit_html_h.createTreeWalker(lit_html_h, 129, null, !1),
      E = (t, i) => {
        const s = t.length - 1,
          n = [];
        let h,
        ...
        for (let i = 0; i < s; i++) {
          ...
          for (
            ;
            g < s.length && ((d.lastIndex = g), (u = d.exec(s)), null !== u);
          ...
          r +=
            d === v
              ...
              : c >= 0
              ? (n.push(e),
                s.slice(0, c) + "$lit$" + s.slice(c) + lit_html_o + y)
              : s + lit_html_o + (-2 === c ? (n.push(void 0), i) : y);
        }
        const u = r + (t[s] || "<?>") + (2 === i ? "</svg>" : "");
        if (!Array.isArray(t) || !t.hasOwnProperty("raw"))
          throw Error("invalid template strings array");
        return [void 0 !== lit_html_e ? lit_html_e.createHTML(u) : u, n];
      };
    class C {
          ...
          if (1 === l.nodeType) {
            if (l.hasAttributes()) {
              ...
              for (const i of l.getAttributeNames())
                if (i.endsWith("$lit$") || i.startsWith(lit_html_o)) {
                  const s = a[d++];
            ...
            if ($.test(l.tagName)) {
              const t = l.textContent.split(lit_html_o),
                i = t.length - 1;
              if (i > 0) {
                l.textContent = lit_html_s ? lit_html_s.emptyScript : "";
                for (let s = 0; s < i; s++)
                  l.append(t[s], lit_html_r()),
                    A.nextNode(),
                    c.push({ type: 2, index: ++h });
                l.append(t[i], lit_html_r());
              }
            }
          } else if (8 === l.nodeType)
            if (l.data === lit_html_n) c.push({ type: 2, index: h });
            else {
              let t = -1;
              for (; -1 !== (t = l.data.indexOf(lit_html_o, t + 1)); )
                c.push({ type: 7, index: h }), (t += lit_html_o.length - 1);
            }
          h++;
        }
      }
      static createElement(t, i) {
        const s = lit_html_h.createElement("template");
    ...
    class N {
      ...
      g(t) {
        this._$AH !== b && lit_html_d(this._$AH)
          ? (this._$AA.nextSibling.data = t)
          : this.T(lit_html_h.createTextNode(t)),
          (this._$AH = t);
      }
      $(t) {
        var i;
        const { values: s, _$litType$: e } = t,
          o =
            "number" == typeof e
              ? this._$AC(t)
              : (void 0 === e.el && (e.el = C.createElement(e.h, this.options)),
                e);
    ...
    class lit_html_S {
      ...
      _$AI(t, i = this, s, e) {
        ...
        if (void 0 === o)
          (t = P(this, t, i, 0)),
            (n = !lit_html_d(t) || (t !== this._$AH && t !== x)),
            n && (this._$AH = t);
        else {
          const e = t;
          let l, h;
          for (t = o[0], l = 0; l < o.length - 1; l++)
            (h = P(this, e[s + l], i, l)),
              h === x && (h = this._$AH[l]),
              n || (n = !lit_html_d(h) || h !== this._$AH[l]),
              h === b
                ? (t = b)
                : t !== b && (t += (null != h ? h : "") + o[l + 1]),
              (this._$AH[l] = h);
        }
        n && !e && this.j(t);
      }
    ...
    const R = lit_html_s ? lit_html_s.emptyScript : "";
    ...
    const L = {
      ...
      z = lit_html_i.litHtmlPolyfillSupport;
    null == z || z(C, N),
      (null !== (lit_html_t = lit_html_i.litHtmlVersions) &&
      void 0 !== lit_html_t
        ? lit_html_t
        : (lit_html_i.litHtmlVersions = [])
      ).push("2.6.1");
    const Z = (t, i, s) => {
      var e, o;
      const n =
    ...
    (lit_element_s.finalized = !0),
      ...
      null === (lit_element_l = globalThis.litElementHydrateSupport) ||
        void 0 === lit_element_l ||
        lit_element_l.call(globalThis, { LitElement: lit_element_s });
    const lit_element_n = globalThis.litElementPolyfillSupport;
    null == lit_element_n || lit_element_n({ LitElement: lit_element_s });
    const lit_element_h = {
      _$AK: (t, e, i) => {
        t._$AK(e, i);
      },
    ...
    (null !== (lit_element_o = globalThis.litElementVersions) &&
    void 0 !== lit_element_o
      ? lit_element_o
      : (globalThis.litElementVersions = [])
    ).push("3.2.2"); // CONCATENATED MODULE: ./node_modules/lit/index.js // CONCATENATED MODULE: ./node_modules/lit-html/directive.js
     ...
     */ const class_map_o = directive_e(
      class extends directive_i {
        constructor(t) {
          ...
          if (
            (super(t),
            t.type !== directive_t.ATTRIBUTE ||
              "class" !== t.name ||
              (null === (i = t.strings) || void 0 === i ? void 0 : i.length) >
                2)
          )
            throw Error(
        ...
        update(i, [s]) {
          ...
          for (const t in s) {
            ...
            i === this.nt.has(t) ||
              ...
              (i
                ? (e.add(t), this.nt.add(t))
                : (e.remove(t), this.nt.delete(t)));
          }
          return x;
        }
      }
    ); // CONCATENATED MODULE: ./node_modules/lit/directives/class-map.js // CONCATENATED MODULE: ./src/scripts/local_save.js
    ...
    customElements.define("c-button", C_Button); // CONCATENATED MODULE: ./src/components/modal.js
    ...
    customElements.define("c-modal", C_Modal); // CONCATENATED MODULE: ./src/components/page.js
    ...
    customElements.define("c-page", C_Page); // CONCATENATED MODULE: ./node_modules/axios/lib/helpers/bind.js
    ...
    var browser = __webpack_require__(230); // CONCATENATED MODULE: ./node_modules/axios/lib/env/classes/FormData.js
    /* harmony default export */ const classes_FormData = browser; // CONCATENATED MODULE: ./node_modules/axios/lib/helpers/toFormData.js
    ...
    /* harmony default export */ const classes_URLSearchParams =
      typeof URLSearchParams !== "undefined"
        ? URLSearchParams
        : helpers_AxiosURLSearchParams; // CONCATENATED MODULE: ./node_modules/axios/lib/platform/browser/classes/FormData.js

    /* harmony default export */ const browser_classes_FormData = FormData; // CONCATENATED MODULE: ./node_modules/axios/lib/platform/browser/index.js
    ...
    function toURLEncodedForm(data, options) {
      return helpers_toFormData(
        data,
        new platform_browser.classes.URLSearchParams(),
        Object.assign(
          {
    ...
    /* harmony default export */ const cancel_CanceledError = CanceledError; // CONCATENATED MODULE: ./node_modules/axios/lib/helpers/null.js

    // eslint-disable-next-line strict
    /* harmony default export */ const helpers_null = null; // CONCATENATED MODULE: ./node_modules/axios/lib/core/settle.js
    ...
    /* harmony default export */ const cookies =
      platform_browser.isStandardBrowserEnv
      ...
      function (config) {
        return new Promise(function dispatchXhrRequest(resolve, reject) {
          ...
          if (
            ...
            (platform_browser.isStandardBrowserEnv ||
              platform_browser.isStandardBrowserWebWorkerEnv)
          ) {
    ...
    const VERSION = "1.2.6"; // CONCATENATED MODULE: ./node_modules/axios/lib/helpers/validator.js
    const validators = {};
    ...
    /* harmony default export */ const lib_axios = axios; // CONCATENATED MODULE: ./src/scripts/movie_api.js
    ...
    /* harmony default export */ const notfound =
      __webpack_require__.p + "assets/notfound.jpg";
    // EXTERNAL MODULE: ./node_modules/notiflix/dist/notiflix-aio-3.2.6.min.js
    var notiflix_aio_3_2_6_min = __webpack_require__(784);
    var notiflix_aio_3_2_6_min_default = /*#__PURE__*/ __webpack_require__.n(
      notiflix_aio_3_2_6_min
    ...
    class MovieCard extends lit_element_s {
      ...
      btnEvents() {
        /* eslint-disable */ oo_oo(),
          console.log(this.API.url, this.searching, `476ac1f_0`);
      ...
      createMovieCard(movies, genres) {
        const cards = movies
          .map((movie) => {
            ...
            url =
              url === null ? notfound : `https://image.tmdb.org/t/p/w500${url}`;
        ...
        this.API.getAllData()
          .then((movies) => {
            if (movies.results.length == 0) {
              notiflix_aio_3_2_6_min_default().Notify.failure(
                "sorry, not found"
              );
            }
    ...
    customElements.define("c-main", C_Main); // CONCATENATED MODULE: ./src/assets/desktop_user.png
    /* harmony default export */ const desktop_user =
      __webpack_require__.p + "assets/desktop_user.png"; // CONCATENATED MODULE: ./src/assets/desktop_main.png
    /* harmony default export */ const desktop_main =
      __webpack_require__.p + "assets/desktop_main.png"; // CONCATENATED MODULE: ./src/assets/film_icon.png
    /* harmony default export */ const film_icon =
      __webpack_require__.p + "assets/film_icon.png"; // CONCATENATED MODULE: ./src/scripts/assets.js
    const assets_images = {
      desktop_user: desktop_user,
      desktop_main: desktop_main,
      icon: film_icon,
    };
    /* harmony default export */ const assets = assets_images; // CONCATENATED MODULE: ./src/components/nav.js
    ...
    customElements.define("c-nav", C_Nav); // CONCATENATED MODULE: ./src/components/header.js
    ...
    customElements.define("c-header", C_Header); // CONCATENATED MODULE: ./src/components/search.js
    ...
    customElements.define("c-search", C_Search); // CONCATENATED MODULE: ./src/assets/heart.png
    /* harmony default export */ const heart =
      __webpack_require__.p + "assets/heart.png"; // CONCATENATED MODULE: ./src/components/footer.js
    ...
    customElements.define("c-footer", C_Footer); // CONCATENATED MODULE: ./src/components/root.js
    ...
    customElements.define("c-root", C_Root); // CONCATENATED MODULE: ./src/scripts/index.js
  })();
